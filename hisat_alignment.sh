...
hisat2 --phred33 -p 8 -x $home_path/Reference_index/GRCh38 -1 $references_path/1_1_L3_R1_001_ij43KLkHk1vK.fastq.gz  -2 $references_path/1_1_L3_R2_001_qyjToP2TB6N7.fastq.gz -S $home_path/SAM/1_1.sam
hisat2 --phred33 -p 8 -x $home_path/Reference_index/GRCh38 -1 $references_path/1_2_L3_R1_001_DnNWKUYhfc9S.fastq.gz -2 $references_path/1_2_L3_R2_001_SNLaVsTQ6pwl.fastq.gz -S $home_path/SAM/1_2.sam
hisat2 --phred33 -p 8 -x $home_path/Reference_index/GRCh38 -1 $references_path/1_5_L3_R1_001_iXvvRzwmFxF3.fastq.gz  -2 $references_path/1_5_L3_R2_001_iXCMrktKyEh0.fastq.gz -S $home_path/SAM/1_3.sam
